...
public abstract class Logic extends JFrame implements Elements{
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                try {
                    ...
                    if (jogoEmAndamento) {
                        ...
                        contadorJogadas++;
                        plays.setText("Jogadas: " + contadorJogadas);
                        System.out.println("Jogada: " + contadorJogadas + " | Próximo Turno: " + turnoAtual);
                        ...
                        if (turnoAtual.equals("C")){
                            ...
                            player.setText("Jogador atual: Carcará");
                        }
                    }
    ...
    private static void verificarFimDeJogo() {
        ...
        Main.playClick("playClick/win.wav");
